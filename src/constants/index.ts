      ...
      list: [
        {
          ...
          name: '(주)천재교과서',
          desc: '교육 플랫폼 밀크T의 웹·태블릿·모바일 서비스를 중심으로 다양한 학습 콘텐츠 UI를 담당하며 서비스 운영 및 고도화에 참여했습니다. 기획 및 디자인 시안을 바탕으로 디바이스별 특성을 고려한 화면을 구성하며 다양한 디바이스와 해상도에 대응하는 퍼블리싱을 진행했습니다. 기존 서비스의 UI를 유지·보수하는 동시에 신규 기능 및 콘텐츠 화면을 개발하며 서비스 품질과 사용성을 개선했습니다.',
          link: {
        ...
        },
        {
          ...
          name: '(주)미플즈',
          desc: '다양한 고객사 프로젝트에서 Vue.js, React 등 여러 프레임워크 환경의 반응형 웹을 퍼블리싱하며 기획자·디자이너·개발자와 긴밀하게 협업하여 사용자 중심의 UI를 구현했습니다. 특히 Vue.js 기반 업무 시스템의 공통 컴포넌트 퍼블리싱을 담당하며 프로젝트 전반의 UI 일관성과 유지보수성을 높였습니다. PC·모바일·태블릿 등 다양한 디바이스 환경에 대응하는 반응형 웹을 구현하고 기존 서비스의 UI 개선 및 리뉴얼을 통해 사용성과 접근성을 향상시켰습니다. 프로젝트 초기 기획 및 디자인 단계부터 개발 과정까지 적극적으로 소통하며 디자인 의도를 정확하게 구현하고 개발 환경과 서비스 특성을 고려한 효율적인 퍼블리싱을 진행했습니다.',
          link: {
